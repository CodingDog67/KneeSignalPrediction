...
-------------------------------
Semi-automatic Segmentation GUI
    - Import the WAV file
    ...
    - Export the indices of each segment to XML file
    - Export the segments to WAV files
*** Canopy Enthought need to be changed to a non-interactive backend
*** Canopy / Preferences > Python > Pylab backend > Inline SVG
Version: 1.0
Author: Tuan Nam Le
...
def ExportToXML():
    ...
    if len(XSEGMENTS)%2:
        ...
        ElementTree(xml_Root).write(output_xmlfile)
...
if __name__ == '__main__':
    ...
    root.wm_title("Semi-automatic Segmentation GUI")
